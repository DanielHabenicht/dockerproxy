          ...
          .prompt([
            {
              ...
              name : 'overwrite',
              message :
                  'A settings.json File already exists. Do you want to override?',
              default : false,
            },
          ])
          .then((answers) => { resolve(answers.overwrite); });
    });
  },
    ...
    if (!previousConfig) {
      ...
      return new Promise((resolve, reject) => {
        inquirer
            .prompt([
              {
                ...
                name : 'proxyAddress',
                message :
                    `What is the proxy domain you want to use? (e.g. proxy.domain.de)`,
              ...
              },
              {
                ...
                name : 'network',
                message :
                    `Which network should be proxied? (Leave blank to proxy all.)`,
                default : '',
              },
              {
                type : 'input',
            ...
            .then((answers) => { resolve(answersToConfigObject(answers)); });
      });
    } else {
